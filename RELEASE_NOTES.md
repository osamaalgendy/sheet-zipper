...
- analysis for XLSX, XLSM, and XLSB workbook packages;
- Balanced, Maximum, and Content-aware optimization modes;
- checksummed XLZ archive creation and verified restoration;
- multi-file jobs, cancellation, persistent activity, and recovery guidance;
- source-change detection, destination preflight, and temporary-file cleanup.
